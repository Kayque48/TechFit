...
<body>
 ...
 <nav class="techfit-sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link" data-section="plano" onclick="mostrarSecao('plano'); return false;">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link" data-section="ficha" onclick="mostrarSecao('ficha'); return false;">
