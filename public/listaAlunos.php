...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // DELETE
    if ($acao == 'deletar' && isset($_POST['idAluno'])) {
        try {
            $controllerAluno->excluir($_POST['idAluno']);
    ...
    // UPDATE
    if ($acao == 'atualizar' && isset($_POST['idAluno'])) {
        ...
        if (!empty($nome) && !empty($dataNasc) && !empty($endereco) && !empty($email)) {
            try {
                $controllerAluno->atualizar(
                    $_POST['idAluno'],
                    $nome,
                    $dataNasc,
                    $endereco,
...
if (isset($_GET['editar'])) {
    $alunoEditando = $controllerAluno->lerPorId($_GET['editar']);
    if (!$alunoEditando) {
        $erro = "Ficha não encontrada!";
    }
}

$alunos = $controllerAluno->ler();
...
<body>
    ...
    <main class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col-md-8">
                <h2><i class="fas fa-chart-line me-2"></i> Alunos Cadastrados na TechFit</h2>
            </div>
        ...
        <!-- Modo Edição -->
        <?php if ($alunoEditando): ?>
            <div class="card card-warning mb-4">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">
                        <i class="fas fa-user-edit me-2"></i> Editar Cadastro do Aluno
                    </h5>
                </div>
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="idAluno" value="<?= htmlspecialchars($alunoEditando->getId()) ?>">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nome" name="nome"
                                    value="<?= htmlspecialchars($alunoEditando->getNome()) ?>" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="dataNasc" name="dataNasc"
                                    value="<?= htmlspecialchars($alunoEditando->getDataNasc()) ?>" required>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="endereco" name="endereco"
                                    value="<?= htmlspecialchars($alunoEditando->getEndereco()) ?>">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="telefone" name="telefone"
                                    value="<?= htmlspecialchars($alunoEditando->getTelefone()) ?>" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    value="<?= htmlspecialchars($alunoEditando->getEmail()) ?>" required>
                            </div>
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <a href="listaAlunos.php" class="btn btn-secondary btn-lg ms-2">
            ...
            <div class="card-body p-0">
                <?php if (empty($alunos)): ?>
                    <div class="alert alert-info m-3">
                        ...
                        <a href="cadastroAluno.php" class="alert-link">Cadastrar um novo</a>
                    </div>
                <?php else: ?>
                        ...
                        <table class="table table-hover mb-0 tabela-alunos">
                            ...
                            <tbody>
                                <?php foreach ($alunos as $aluno): ?>
                                    <tr>
                                        <td>
                                            <strong><?= htmlspecialchars($aluno->getNome()) ?></strong>
                                        </td>

                                        <td>
                                            <?= date('d/m/Y', strtotime($aluno->getDataNasc())) ?>
                                        </td>

                                        <td>
                                            <?= htmlspecialchars($aluno->getTelefone()) ?>
                                        </td>

                                        <td>
                                            <?= htmlspecialchars($aluno->getEmail()) ?>
                                        </td>

                                        <td>
                                            <?php if (!empty($aluno->getPlano())): ?>
                                                <span class="badge bg-info">
                                                    <?= htmlspecialchars($aluno->getPlano()) ?>
                                                </span>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <a href="?editar=<?= $aluno->getId() ?>" class="btn btn-sm btn-warning"
                                                title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>

                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal<?= $aluno->getId() ?>" title="Deletar">
                                    ...
                                    <div class="modal fade" id="deleteModal<?= $aluno->getId() ?>" tabindex="-1">
