...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <symbol id="moon-stars-fill" viewBox="0 0 16 16">
      ...
      <path d="M10.794 3.148a.217.217 0 0 1 ..."></path>
    </symbol>
  ...
  <main class="form-signin w-100 m-auto">
    <form>
      <img class="mb-4" src="TECHFIT_LOGOpng.png" alt="Logo" width="100" height="">
      ...
      <div class="form-check text-start my-3">
        ...
        <label class="form-check-label" for="checkDefault">Lembrar-me</label>
      </div>

      <ul>
        <li><a href="">Esqueceu a senha?</a></li>
        <li>Não tem uma conta? <a href="cadUser.html">Cadastro</a></li>
      </ul>

      <button class="btn btn-primary w-100 py-2" type="submit">Entrar</button>

      <button class="btn btn-primary w-100 py-2" type="submit">ADM</button>
